...
pub mod credential {
    ...
    pub type Request = crate::request::Request<CoreProfilesCredentialRequest>;
    pub type BatchRequest = crate::batch::request::BatchRequest<CoreProfilesCredentialRequest>;
}
