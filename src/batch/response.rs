...
use crate::{profiles::CredentialResponseProfile, response::ResponseKind, types::Nonce};
    ...
    CR: CredentialResponseProfile,
{
    ...
    pub credential_responses: Vec<ResponseKind<CR>>,
...
impl<CR> BatchCredentialResponse<CR>
where
    CR: CredentialResponseProfile,
{
    pub fn new(credential_responses: Vec<ResponseKind<CR>>) -> Self {
        Self {
...
mod tests {
    ...
    fn example_batch_response() {
        let _: BatchCredentialResponse<CoreProfilesCredentialResponse> =
